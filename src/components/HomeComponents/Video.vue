...
const filteredList = computed(() => filesStore.videos);
...
const fileTypeIcons = {
  'mp4视频文件': '/src/assets/icon/mp4-1.png',
  'avi视频文件': '/src/assets/icon/avi.png',
  'mkv视频文件': '/src/assets/icon/mkv.png',
  'mov视频文件': '/src/assets/icon/mov.png'
};



const rowSelected = (rows) => {
  console.log('选中视频:', rows);
};
</script>
